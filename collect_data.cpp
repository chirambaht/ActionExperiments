...
VectorInt16
    accReal; // [x, y, z]            gravity-free accel sensor measurements
VectorInt16
    accWorld; // [x, y, z]            world-frame accel sensor measurements
...
FILE *arq_Accel, *arq_Gyro, *arq_Quaternions, *arq_Euler, *arq_YawPitchRoll,
    *arq_LinearAcc, *arq_WorldAcc;
...
void setup() {
  ...
  //            ZAccel			               XGyro
  //            YGyro			              ZGyro
  //[-2679,-2678] --> [-15,1]	[398,398] --> [-1,2]	[1205,1206] -->
  //[16381,16391]	[-116,-115] --> [-4,2]	[69,70] --> [0,3]
  //[-93,-92]
  //--> [0,3]
  ...
  if (devStatus == 0) {
    ...
    // interrupt 0)...")); attachInterrupt(0, dmpDataReady, RISING);
...
void loop() {
  ...
  if (fifoCount == 1024) {
    ...
    // aaWorld.x/4096, (double) aaWorld.y/4096, (double) (aaWorld.z-4096)/4096);
#endif
